...
exports.handleSubmit = exports.editEnd = exports.editStart = exports.destroyFilter = exports.initializeFilter = exports.clearSelection = exports.changeSelection = exports.changeData = exports.destroyGrid = exports.initializeGrid = exports.changeSort = exports.changePageSize = exports.changePage = exports.applyFilter = undefined;
...
var clearSelection = exports.clearSelection = function clearSelection(name) {
    return {
...
var handleSubmit = exports.handleSubmit = function handleSubmit(values, grid, rowData, editRoute) {
    return function (dispatch, getState) {
        ...
        var data = _extends({}, rowData, editFormValues, values);

        return dispatch((0, _wikomData.submit)({ url: editRoute, data: data }));
    };
};