...
exports.submitField = exports.destroyFilter = exports.initializeFilter = exports.changeSelection = exports.changeData = exports.destroyGrid = exports.fieldSubmissionFailed = exports.fieldInSubmission = exports.fieldSaved = exports.fieldChanged = exports.setNextEditRow = exports.initializeGrid = exports.changeSort = exports.changePageSize = exports.changePage = exports.applyFilter = undefined;
...
var setNextEditRow = exports.setNextEditRow = function setNextEditRow(name, index) {
    return {
...
var fieldChanged = exports.fieldChanged = function fieldChanged(name, idx) {
    return {
...
var fieldSaved = exports.fieldSaved = function fieldSaved(name, idx) {
    return {
...
var fieldInSubmission = exports.fieldInSubmission = function fieldInSubmission(name, idx) {
    return {
...
var fieldSubmissionFailed = exports.fieldSubmissionFailed = function fieldSubmissionFailed(name, idx) {
    return {
...
var submitField = function submitField(_ref2) {
    ...
    data[idx] = value;
    return (0, _wikomData.submit)({ url: url, data: data });

    //ToDo: Nur bei Änderung...
    if ((0, _findInObject2.default)(idx, data) != value) {
        data[idx] = value;
