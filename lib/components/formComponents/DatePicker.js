...
var DatePicker = function DatePicker(_ref) {
    ...
    var value = input.value && _moment2.default.utc(input.value, [dateFormat, 'YYYY-MM-DD', _moment2.default.ISO_8601]);
    var valueForPicker = value && value.format('YYYY-MM-DD');
