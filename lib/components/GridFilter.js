...
var mapStateToProps = function mapStateToProps(state, props) {
    ...
    return {
        ...
        children: _react2.default.Children.map(props.children, function (child) {
            if (_react2.default.isValidElement(child) && child.type === _Filter2.default && state.grid[props.grid] && state.grid[props.grid].filter.hasOwnProperty(child.props.name)) {
