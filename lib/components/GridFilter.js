...
var mapStateToProps = function mapStateToProps(state, props) {
    ...
    return {
        ...
        children: _react2.default.Children.map(props.children, function (child) {
            if (_react2.default.isValidElement(child) && child.type === _Filter2.default && state.grid[props.grid] && state.grid[props.grid].filter.hasOwnProperty(child.props.name) && state.grid[props.grid].filter[child.props.name] !== null) {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, props) {
    return {
        ...
        clearFilter: function clearFilter() {
            return dispatch((0, _actions.applyFilter)(props.initialValues, props.grid));
        }
    };
};
...
var mapDispatchForWrapper = function mapDispatchForWrapper(dispatch, props) {
    return {
        initializeFilter: function initializeFilter() {
            return dispatch((0, _actions.initializeFilter)(props.grid, props.initialValues));
        }
    };
};
