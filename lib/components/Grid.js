...
var Grid = function (_React$Component) {
    ...
    _createClass(Grid, [{
        ...
        value: function buildRows(_ref) {
            ...
            ) : data && data.length > 0 ? data.map(function (rowData) {
                return _react2.default.createElement(
                    _Row2.default,
                    { rowData: rowData, key: rowData.id, grid: grid },
                    _this2._columns
                );
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        { className: 'box-body' },
                        actions,
                        hasPagination ? _react2.default.createElement(_Pagination2.default, _extends({ grid: grid }, pagination)) : null,
                        _react2.default.createElement(
                            'div',
                            { className: 'row' },
                            _react2.default.createElement(
...
Grid.propTypes = {
    ...
    initializeGrid: _propTypes2.default.func.isRequired,
    destroyGrid: _propTypes2.default.func.isRequired
};
...
exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(Grid);