        ...
        value: function buildRows(_ref) {
            ...
            return isLoading ? _react2.default.createElement(
                ...
                if (_this2._rowInEdit === i) {
                    console.log(i + ' row in edit!');
                    return _react2.default.createElement(
                        _Row2.default,
                        { rowData: rowData, key: i, rowId: i, grid: grid, editable: _this2.props.editRoute || false },
                        _this2._editColumns
                    );
                } else {
                    return _react2.default.createElement(
...
var GridContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Grid);
