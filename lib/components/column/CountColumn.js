...
var countValues = function countValues(data) {
  return data instanceof Array ? data.length : 0;
};

var CountColumn = function CountColumn(_ref) {
  var name = _ref.name,
      rowData = _ref.rowData,
      idx = _ref.idx,
      rest = _objectWithoutProperties(_ref, ["name", "rowData", "idx"]);

  return _react["default"].createElement(_BaseColumn["default"], rest, countValues((0, _findInObject["default"])(idx, rowData)));
};
...
CountColumn.propTypes = {
  ...
  idx: _propTypes["default"].oneOfType([_propTypes["default"].number, _propTypes["default"].string]).isRequired
};
var _default = CountColumn;
