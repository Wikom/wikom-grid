...
var CountColumn = function CountColumn(_ref) {
    ...
    return _react2.default.createElement(
        ...
        rest,
        countValues((0, _findInObject2.default)(idx, rowData))
    );
};
...
CountColumn.propTypes = {
    ...
    idx: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.string]).isRequired
};

exports.default = CountColumn;