...
var mapState = function mapState(_ref, _ref2) {
    ...
    return {
        ...
        changedRowData: grid[gridname].edit && grid[gridname].edit.values && grid[gridname].edit.values[rowId] && grid[gridname].edit.values[rowId].hasOwnProperty(colId) && _extends({}, rowData, _defineProperty({}, idx, grid[gridname].edit.values[rowId][colId])) || null,
