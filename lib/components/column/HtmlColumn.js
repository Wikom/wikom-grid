...
var HtmlColumn = function HtmlColumn(_ref) {
  var name = _ref.name,
      rowData = _ref.rowData,
      idx = _ref.idx,
      rest = _objectWithoutProperties(_ref, ["name", "rowData", "idx"]);

  return _react["default"].createElement(_BaseColumn["default"], rest, _react["default"].createElement("span", {
    dangerouslySetInnerHTML: {
      __html: (0, _findInObject["default"])(idx, rowData)
    }
  }));
};
