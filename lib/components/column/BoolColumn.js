...
var BoolColumn = function BoolColumn(_ref) {
    ...
    var isTrue = [true, 'true', 1, '1', 'j', 'J'].indexOf((0, _findInObject2.default)(idx, rowData)) > -1;

    return _react2.default.createElement(
        _BaseColumn2.default,
        rest,
        isTrue === true ? _react2.default.createElement(_reactSymbol2.default, { symbol: { symbol: "check", className: "text-success" } }) : _react2.default.createElement(_reactSymbol2.default, { symbol: { symbol: "times", className: "text-danger" } })
    );
};
