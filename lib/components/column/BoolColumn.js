...
var BoolColumn = function BoolColumn(_ref) {
    ...
    return _react2.default.createElement(
        ...
        rest,
        (0, _findInObject2.default)(idx, rowData) ? _react2.default.createElement(_reactSymbol2.default, { symbol: { symbol: "check", className: "text-success" } }) : _react2.default.createElement(_reactSymbol2.default, { symbol: { symbol: "times", className: "text-danger" } })
    );
};
