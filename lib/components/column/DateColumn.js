...
var DateColumn = function DateColumn(_ref) {
  var name = _ref.name,
      ...
      idx = _ref.idx,
      format = _ref.format,
      rest = _objectWithoutProperties(_ref, ["name", "rowData", "idx", "format"]);

  var val = (0, _findInObject["default"])(idx, rowData);
  return _react["default"].createElement(_BaseColumn["default"], rest, val ? _moment["default"].utc(val).format(format || 'DD.MM.YYYY') : null);
};
