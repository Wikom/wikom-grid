...
var SymbolColumn = function SymbolColumn(_ref) {
  ...
  var symbol = symbols[(0, _findInObject["default"])(idx, rowData)];
  return _react["default"].createElement(_BaseColumn["default"], rest, symbol ? _react["default"].createElement(_reactSymbol["default"], {
    symbol: symbol
  }) : null);
};
