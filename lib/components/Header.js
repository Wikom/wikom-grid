    ...
    return _react2.default.createElement(
        ...
        columns.map(function (column, key) {
            var _column$props = column.props,
                ...
                cellWidth = _column$props$cellWid === undefined ? false : _column$props$cellWid,
                _column$props$sortabl = _column$props.sortable,
                sortable = _column$props$sortabl === undefined ? true : _column$props$sortabl;


            if (ThComponent) {
                return _react2.default.createElement(ThComponent, { grid: grid, name: name, key: key, idx: idx, cellWidth: cellWidth });
            }
            ...
            var thInner = _react2.default.createElement(
                'span',
